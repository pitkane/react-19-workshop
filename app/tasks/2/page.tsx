        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <ol className="list-decimal pl-6 space-y-4">
              ...
              <li>
                <p>Add the 'use client' directive at the top of the file to enable hooks and browser interactions:</p>
              ...
              <li>
                <p>
                  Verify that the products are rendered on the server, but the like button functionality works on the
                  client.
                </p>
              </li>
            </ol>
