          ...
          <div className="space-y-6">
            <div className="rounded-lg border p-6 bg-green-50">
              ...
              <p className="text-sm text-green-700">
                This page demonstrates a fully working Server Component that fetches character data from the Rick and
                Morty API and renders it on the server. The data is fetched during the server-side render and included
                in the initial HTML.
              </p>
            </div>
            ...
            {characters.length === 0 ? (
              <div className="text-center py-12 bg-red-50 rounded-lg border border-red-200">
                ...
                <p className="text-red-600">
                  There was an error fetching data from the Rick and Morty API. Please check your internet connection
                  and try again.
                </p>
              </div>
            ) : (
