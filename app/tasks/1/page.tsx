        ...
        <div className="flex flex-1 flex-col gap-8 p-8">
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p>
                Create a Server Component that fetches character data from the Rick and Morty REST API and renders it on
                the server.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <ol className="list-decimal pl-6 space-y-4">
                  <li>
                    <p>
                      Work in the file <code>app/tasks/1/work/page.tsx</code> - this is your workspace for implementing
                      the solution.
                    </p>
                  </li>
                  <li>
                    <p>
                      Create a Server Component that fetches character data from the Rick and Morty API. Since it's a
                      Server Component, you can await directly in the component body:
                    </p>
                  ...
                  <li>
                    <p>
                      API Endpoint: <code>https://rickandmortyapi.com/api/character</code> - returns the first 20
                      characters with pagination info.
                    </p>
                  </li>
                  <li>
