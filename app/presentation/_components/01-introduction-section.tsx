export default function IntroductionSection() {
  return (
    <section id="introduction" className="space-y-4">
      <h1 className="text-4xl font-bold">01. What's New in React 19</h1>
      <div className="space-y-4">
        <p className="text-lg">
          Welcome to our React 19 workshop! This session is designed for experienced React & TypeScript developers
          working with Next.js 15 and the App Router. We'll explore the latest features and improvements in React 19,
